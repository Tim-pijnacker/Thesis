...
from cuda.nsection import entmax_nsect_cuda, entmax_nsect_cuda1
...
def test_nsection_out(alpha, dtype, device, dim):
    ...
    if device == torch.device("cuda:0"):
        ...
        y_hat_cuda1 = entmax_nsect_cuda1(x, alpha, n_iter=50, n_sections=2)
    ...
    if device == torch.device("cuda:0"):
        ...
        assert torch.allclose(y_hat_cuda1, y_true)
...
out1 = entmax_nsect_cuda1(x, 1.75, 50, 2)
