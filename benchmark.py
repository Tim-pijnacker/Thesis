...
def main():
    ...
    bench = benchmarker(alpha = 1.5, nsct_iter = 12, bisct_iter = 24, n_sections = 4, rows = [10000, 20000, 32000], cols = [32000], models=["cuda"])
    bench.initialise_bench(threads=[1])
    bench.compare()

    bench = benchmarker(alpha = 1.5, nsct_iter = 12, bisct_iter = 24, n_sections = 4, rows = [10000, 20000, 32000], cols = [32000], models=["bisct"])
    bench.initialise_bench(threads=[1])
    bench.compare()
